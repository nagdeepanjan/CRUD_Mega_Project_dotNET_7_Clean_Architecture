...
namespace ContactsManager.UI.Controllers
{
    ...
    [AllowAnonymous]                    //This currently clashes with the policy [Authorize("NotAuthorized")]. Please remove either those attributes or this (AllowAnonymous)
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [Authorize("NotAuthorized")]        //Policy name defined in program.cs
